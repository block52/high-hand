...
namespace src
{
    class Program
    {
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    case "demo":
                        ...
                        break;
                    case "keypair":
                        Console.WriteLine("Generate new keypair");

                        GenerateKeyPair();

                        break;
                    case "chain":
                        Console.WriteLine("Starting new chain");
                        break;
                }
            }
        }
        ...
        public static AsymmetricCipherKeyPair GenerateKeyPairRSA()
        {
            Console.WriteLine();
        ...
        public static void GenerateKeyPair()
        {
            ...
            String pk = ExportPublicKey(initialProvider);
